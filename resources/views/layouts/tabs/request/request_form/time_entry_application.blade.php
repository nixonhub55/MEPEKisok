...
<?php
      ...
      foreach ($selected_row['rows'] as $rows){
            ...
            $fullname = $rows->teName;  
            $empID = $rows->teID;   
            $center = $rows->costName;   
...
<div id="filing-panel" class="container custom-container">
      <form class="row g-3">
            <div class="col-12">
                  <div class="row">
                        <div class="col-md-4">
...
<script>  
      ...
      if(teAppNo!=="N/A" && allowmanpowerlist==0 && (btns)){
            btns.innerHTML = "";
      }
      
      var btnsOriginalHTML = document.getElementById('btns').innerHTML;
      $('#teDate, #teDate').change(async function () { // kiosk locked validation
            var btns = document.getElementById('btns');
            var _from = document.getElementById('teDate').value;
            var _to = document.getElementById('teDate').value;   
