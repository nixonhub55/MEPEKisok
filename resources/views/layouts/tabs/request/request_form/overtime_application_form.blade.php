...
use PhpParser\Node\Stmt\Echo_;
      ...
      foreach ($overtime['rows'] as $rows) {
            ...
            $center=$rows->otCosCenter;
            $empID=$rows->otID;
            $fullname=$rows->otName;
      ...
      //echo json_encode($overtime['rows']);
?>
      ...
      <form class="row g-3">
            ...
            <div class="col-12">
                  <div class="row">
                        ...
                        <div class="col-md-4">
                              <label id="lbl_ot_date" for="ot_date" class="form-label">Work Date</label>
...
<script>
      ...
      if(otAppNo!=="N/A" && allowmanpowerlist==0 && (btns)){
            btns.innerHTML = "";
      }

      var btnsOriginalHTML = document.getElementById('btns').innerHTML;
      $('#ot_from_date, #ot_to_date').change(async function () { // kiosk locked validation
            var btns = document.getElementById('btns');
            var _from = document.getElementById('ot_from_date').value;
            var _to = document.getElementById('ot_to_date').value;   
