                                    ...
                                    @foreach($list['rows'] as $rows)
                                          <tr>
                                                <td>
                                                      ...
                                                      @else
                                                      <center>
                                                      <input class="form-check-input" id="chkbox{{$num}}" type="checkbox" value="{{$rows->enc_id}}" data-database="{{$rows->r_srcDb}}"  name="{{$rows->obAppNo}}" onclick="return CheckMe(1,this.id,'selectAll','datatablesPending')">
                                                      </center>
                                                      @endif 
                                                </td>
                                                <td>{{$rows->obAppNo}}</td>
                                                ...
                                                <td>
                                                      <div class="btn-container"> 
                                                            <button id="{{$rows->obAppNo}}" class="btn btn-action btn-view" title="More Details" onclick="view_ob_details('{{$rows->enc_id}}',this.id,'{{$rows->enc_pay}}','{{$rows->r_srcDb}}')"><i
...
<script>
      ...
      function view_ob_details(id,objID,enc_pay,r_srcDb){
