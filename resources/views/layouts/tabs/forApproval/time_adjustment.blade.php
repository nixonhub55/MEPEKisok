                              ...
                              <tbody>
                                    ...
                                    <tr>
                                          <td>
                                                ...
                                                @else
                                                <center>
                                                <input class="form-check-input" id="chkbox{{$num}}" type="checkbox"  value="{{$rows->enc_id}}" data-database="{{$rows->r_srcDb}}" name="{{$rows->taAppNo}}" onclick="return CheckMe(1,this.id,'selectAll','datatablesPending')">
                                                </center> 
                                                @endif 
                                          </td> 
                                          <td>{{$rows->taAppNo}}</td>
                                          ...
                                          <td>
                                                <div class="btn-container"> 
                                                      <button id="{{$rows->taAppNo}}" class="btn btn-action btn-view" title="More Details" onclick="view_ta_details('{{$rows->enc_id}}',this.id,'{{$rows->enc_pay}}','{{$rows->r_srcDb}}')"><i
