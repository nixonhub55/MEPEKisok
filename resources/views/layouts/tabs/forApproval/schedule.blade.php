                              ...
                              <tbody>
                                    ...
                                    <tr>
                                          <td>
                                                ...
                                                @else
                                                <center>
                                                <input class="form-check-input" id="chkbox{{$num}}" type="checkbox"  value="{{$rows->enc_id}}"  data-database="{{$rows->r_srcDb}}"  name="{{$rows->scAppNo}}" onclick="return CheckMe(1,this.id,'selectAll','datatablesPending')">
                                                </center>
                                                @endif 
                                          </td> 
                                          <td>{{$rows->scAppNo}}</td>
                                          ...
                                          <td>
                                                <div class="btn-container"> 
                                                      <button id="{{$rows->scAppNo}}" class="btn btn-action btn-view" title="More Details" onclick="view_ta_details('{{$rows->enc_id}}',this.id,'{{$rows->enc_pay}}','{{$rows->r_srcDb}}')"><i
