                        ...
                        <table class="table data-table" id="datatablesPending">
                              ...
                              <tr>
                                    <td>
                                          ...
                                          @else
                                          <center>
                                                <input class="form-check-input" id="chkbox{{$num}}" type="checkbox" value="{{$rows->enc_id}}" data-database="{{$rows->r_srcDb}}" name="{{$rows->laAppNo}}" onclick="return CheckMe(1,this.id,'selectAll','datatablesPending')">
                                          </center>
                                          @endif
                                    ...
                                    <td>
                                          <div class="btn-container"> 
                                                <button id="{{$rows->laAppNo}}" class="btn btn-action btn-view" title="More Details" onclick="view_leave_details('{{$rows->enc_id}}',this.id,'{{$rows->enc_pay}}','{{$rows->r_srcDb}}')"><i
...
<script>
      ...
      function view_leave_details(id,objID,enc_pay,r_srcDb){
