        ...
        <div class="tab-pane fade show active" id="pending" role="tabpanel" aria-labelledby="pending-tab">
            ...
            <div class="table-container">
                <table class="table data-table" id="datatablesPending">
                    ...
                    <tbody>
                        <?php $count = 1; ?>
                        @foreach($employmenthistory as $list)
...
$(document).ready(function () {
    ...
    $(document).on('click', '.open-atd', function () {
        ...
        $.ajax({
            url: "{{ route('hris_approval_employmenthistory_view') }}",
            type: "POST",
            data: {
            ...
            error: function () {
                alert('Error loading employment history details');
            }
        });
    });
    ...
    function bulkSubmit(action) {
        ...
        $.ajax({
            url: "{{ route('hris_approval_employmenthistory_bulk_submit') }}",
            type: "POST",
