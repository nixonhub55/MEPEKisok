...
$(document).ready(function () {
    ...
    $(document).on('click', '.open-atd', function () {
        ...
        $.ajax({
            url: "{{ route('hris_approval_leavecredit_view') }}",
            type: "POST",
            data: {
            ...
            error: function () {
                alert('Error loading leave credit details');
            }
        });
    });
    ...
    function bulkSubmit(action) {
        ...
        $.ajax({
            url: "{{ route('hris_approval_leavecredit_bulk_submit') }}",
            type: "POST",
